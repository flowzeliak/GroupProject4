<?php
/**
 * index.php along with survey_view.php provides a sample List/View application
 * 
 * @package SurveySez
 * @author Christopher Moore <christopher.moore@seattlecentral.edu>
...
$config->titleTag = 'Group Project 4';
...
{#records exist - process
    ...
    {# process each row
        ...
        echo '      
              <tr>
                <td><a href="' . VIRTUAL_PATH . '../rss/survey_view.php?id=' . (int)$row['SurveyID'] . '">' . dbOut($row['Title']) . '</a></td>
