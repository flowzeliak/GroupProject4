...
$sub_folder = 'ITC250/sm18/';//If app installed in subfolder, place here.  name of folder, no leading or trailing forward or backslash
...
define('SUPPORT_EMAIL', 'christopher.moore@seattlecentral.edu'); # Email of site support
